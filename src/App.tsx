...
import DailyPujaEssentialsPage from './pages/DailyPujaEssentialsPage';
        ...
        <CartProvider>
          ...
          <div className="flex flex-col min-h-screen pb-16 md:pb-0">
            <Routes>
              ...
              <Route path="/daily-puja-essentials" element={<><Navbar /><div className="flex-grow"><DailyPujaEssentialsPage /></div><Footer /></>} />
