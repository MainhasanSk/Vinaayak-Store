        ...
        <div className="p-2 md:p-0">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <button
                    ...
                    className="w-full sm:w-auto bg-saffron hover:bg-saffron-dark text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition"
                >
                    <Plus size={20} />
                    Add Product
                </button>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <input
                                            ...
                                            className="w-full text-sm text-gray-500 file:mr-2 md:file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-saffron-dark hover:file:bg-orange-100"
                                        />
