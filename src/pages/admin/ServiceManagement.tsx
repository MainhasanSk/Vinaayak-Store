            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    <button
                        ...
                        className="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 text-sm"
                    >
                        Migrate Old Data
                    </button>
                    <button
                        onClick={() => handleOpenModal()}
                        className="bg-saffron hover:bg-saffron-dark text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition"
                    >
                        <Plus size={20} />
                        Add Service
                    </button>
