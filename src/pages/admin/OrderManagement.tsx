...
Thank you for shopping with Vinayak Store!`;
    ...
    return (
        <div className="p-2 md:p-0">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">Order Management</h1>
                ...
                <div className="space-y-6">
                    {orders.map(order => (
                        <div key={order.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            {/* Order Header */}
                            <div className="bg-gray-50 px-4 md:px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-200">
                                <div>
