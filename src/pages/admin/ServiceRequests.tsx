    ...
    return (
        <div className="p-2 md:p-0">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Service Requests</h1>
                        ...
                        <div key={order.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div className="bg-gray-50 px-4 md:px-6 py-4 border-b border-gray-200">
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                    <div className="grid grid-cols-2 md:flex md:flex-wrap gap-4 md:gap-8 w-full">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="font-bold text-gray-900">{order.shippingDetails.name}</p>
                                        </div>
