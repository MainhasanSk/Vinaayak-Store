            ...
            <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
                ...
                <div className="flex-1 bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                    ...
                    <div className="mb-8 space-y-4">
                        <div className="p-4 bg-orange-50 border-l-4 border-saffron rounded-r-lg flex items-start gap-3 shadow-sm">
                            <div className="text-saffron shrink-0 mt-0.5">
                                <span className="text-xl">🚚</span>
                            </div>
                            <div className="text-sm text-gray-700">
                                <p className="font-bold text-saffron-dark mb-1 text-base">Delivery Policy</p>
                                <p className="leading-relaxed">Free Delivery Around <span className="font-bold underline decoration-saffron/30">Narengi</span>. Out of Narengi Delivery charge will be taken as <span className="font-bold text-saffron-dark">₹20 per km</span>.</p>
                            </div>
                        </div>

                        {total >= 1500 ? (
                            <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3 animate-pulse">
                                <span className="text-2xl">🎉</span>
                                <div>
                                    <p className="text-green-800 font-bold mb-0.5">Free Delivery Unlocked!</p>
                                    <p className="text-green-600 text-xs">Your order is above ₹1500. Enjoy free delivery on your entire purchase!</p>
                                </div>
                            </div>
                        ) : (
                            <div className="p-4 bg-blue-50 border border-blue-100 rounded-lg flex items-center gap-3">
                                ...
                                <div className="text-sm">
                                    <p className="text-blue-800 font-semibold italic">Shop for ₹{1500 - total} more to get <span className="font-bold underline">FREE Delivery</span>!</p>
                                </div>
                            </div>
                        )}
                    </div>
